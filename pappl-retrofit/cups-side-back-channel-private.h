...
enum pr_sc_bidi_e			/**** Bidirectional capability values ****/
{
...
enum pr_sc_command_e			/**** Request command codes ****/
{
  ...
  _PR_SC_CMD_SNMP_GET = 6,		/* Query an SNMP OID @since CUPS 1.4/macOS 10.6@ */
  _PR_SC_CMD_SNMP_GET_NEXT = 7,	/* Query the next SNMP OID @since CUPS 1.4/macOS 10.6@ */
  _PR_SC_CMD_GET_CONNECTED = 8,	/* Return whether the backend is "connected" to the printer @since CUPS 1.5/macOS 10.7@ */
...
enum pr_sc_status_e			/**** Response status codes ****/
{
  ...
  _PR_SC_STATUS_BAD_MESSAGE,		/* The command/response message was invalid */
